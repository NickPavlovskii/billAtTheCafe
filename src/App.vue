  ...
  <div class="cont">
    ...
    <div v-else-if="currentScreen === 'add-persons'" class="add-person">
      <div class="add-person-content">
        ...
        <button @click="goToNextScreen('add-positions')" class="p-mt-3 add-button addbtn result-button">
    ...
    <div v-else-if="currentScreen === 'add-positions'">
      <add-positions :is-name-valid="isNameValid" :is-price-valid="isPriceValid" :is-people-selected="isPeopleSelected"
        @add-position="addPosition" @remove-position="removePosition" />
      <button @click="openPositionModal('bill-result')" class="p-mt-3 add-button addbtn result-button">
        <span class="button-text">Результат<i class="pi pi-chevron-right"></i></span>
        <i class="i"></i>
      </button>
    </div>
